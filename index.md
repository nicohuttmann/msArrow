...
If a series of data exports, say 100s of datasets, the
`clean_memory = T` argument applies a cleanup of the RAM via the
internal
[`cleanMem()`](https://nicohuttmann.github.io/msArrow/reference/cleanMem.md)
function. It’s worth using it if you feel your R session is becoming
slower.
